...
- [CreateDomainName](https://docs.aws.amazon.com/apigatewayv2/latest/api-reference/domainnames.html#CreateDomainName) in the _Amazon API Gateway Version 2 API Reference_
