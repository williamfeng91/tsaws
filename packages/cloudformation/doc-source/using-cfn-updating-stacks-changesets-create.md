...
1. On the **Create change set for _stack\-name_** page, do one of the following to modify input parameter values, specify the location of an updated template, or modify the template:  
...
1. On the **Review _stack\-name_** page, review the changes for this change set\.
