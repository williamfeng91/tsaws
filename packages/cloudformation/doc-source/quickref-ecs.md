...
The following example template deploys a web application in an Amazon ECS container with autoscaling and an application load balancer\. For more information, see [Getting started with Amazon ECS](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ECS_GetStarted.html) in the _Amazon Elastic Container Service Developer Guide_\.

**Important**  
For the latest AMI IDs, see [Amazon ECS\-optimized AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html) in the _Amazon Elastic Container Service Developer Guide_\.
