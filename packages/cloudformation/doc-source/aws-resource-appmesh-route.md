...
- [Routes](https://docs.aws.amazon.com/app-mesh/latest/userguide/routes.html) in the _ AWS App Mesh User Guide _\.
- [CreateRoute](https://docs.aws.amazon.com/app-mesh/latest/APIReference/API_CreateRoute.html) in the _ AWS App Mesh API Reference _\.
