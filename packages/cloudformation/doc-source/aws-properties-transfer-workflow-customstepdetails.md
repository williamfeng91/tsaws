...
<a name="aws-properties-transfer-workflow-customstepdetails-description"></a>The `CustomStepDetails` property type specifies Property description not available\. for an [AWS::Transfer::Workflow](aws-resource-transfer-workflow.md)\.
