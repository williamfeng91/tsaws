...
| \-\-resource \(resource signaling only\)                 | The [logical ID](resources-section-structure.md) of the resource that contains the creations policy you want to signal\. _Type_: String                                                                                                                                              | Yes      |
...
| `waitconditionhandle.url` \(wait condition handle only\) | A presigned URL that you can use to signal success or failure to an associated `WaitCondition` _Type_: String                                                                                                                                                                        | Yes      |
