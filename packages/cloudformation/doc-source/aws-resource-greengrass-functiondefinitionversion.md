...
- [CreateFunctionDefinitionVersion](https://docs.aws.amazon.com/greengrass/latest/apireference/createfunctiondefinitionversion-post.html) in the _ AWS IoT Greengrass Version 1 API Reference _
