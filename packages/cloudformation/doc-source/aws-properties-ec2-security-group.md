...
_Required_: No  
_Type_: List of [Egress](aws-properties-ec2-security-group-rule.md)  
...
_Required_: No  
_Type_: List of [Ingress](aws-properties-ec2-security-group-rule-1.md)  
_Update requires_: [Some interruptions](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-some-interrupt)
...
- [Amazon EC2 security groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-security-groups.html) in the _Amazon EC2 User Guide for Linux Instances_
- [Amazon EC2 security groups](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/ec2-security-groups.html) in the _Amazon EC2 User Guide for Windows Instances_
