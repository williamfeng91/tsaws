...
1. Choose or create a bucket that's located in the same region in which you'll create your AWS CloudFormation stack\. Record the bucket name\.
   ...
   You'll save the sample package in this bucket\. For more information about creating a bucket, see [Creating a bucket](https://docs.aws.amazon.com/AmazonS3/latest/user-guide/CreatingaBucket.html) in the _Amazon Simple Storage Service User Guide_\.

1. Upload the sample package to the bucket that you chose or created\.

   For more information about uploading objects, see [Uploading objects](https://docs.aws.amazon.com/AmazonS3/latest/user-guide/UploadingObjectsintoAmazonS3.html) in the _Amazon Simple Storage Service User Guide_\.
