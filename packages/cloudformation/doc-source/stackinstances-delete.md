...
1. Run the `delete-stack-instances` command\. For `--stack-set-name`, specify the stack set name `my-awsconfig-stackset`\.
   ...
   **Note**  
   ...
   \[Self\-managed permissions\] Replace _account_ID_ with the accounts you used to create your stack set in [Create a stack set](stacksets-getting-started-create.md)\.
