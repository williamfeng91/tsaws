...
/**
 * The `As2Config` property type specifies Property description not available. for an [AWS::Transfer::Connector](aws-resource-transfer-connector.md).
...
export interface TransferConnectorProperties {
  /**
 ...
 */
export interface TransferConnectorResource {
