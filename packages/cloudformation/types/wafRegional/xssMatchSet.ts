...
export interface WAFRegionalXssMatchSetProperties {
  /**
   * Specifies the parts of web requests that you want to inspect for cross-site scripting attacks.
   *
   * _Required_: No
   *
   * _Type_: List of [XssMatchTuple](aws-properties-wafregional-xssmatchset-xssmatchtuple.md)
   *
   * _Update requires_: [No interruption](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-no-interrupt)
   */
  XssMatchTuples?: List<WAFRegionalXssMatchSetXssMatchTuple>;
  /**
 ...
 */
export interface WAFRegionalXssMatchSetResource {
