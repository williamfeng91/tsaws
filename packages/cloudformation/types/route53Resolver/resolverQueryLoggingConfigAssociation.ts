...
export interface Route53ResolverResolverQueryLoggingConfigAssociationProperties {
  /**
 ...
 */
export interface Route53ResolverResolverQueryLoggingConfigAssociationResource {
