...
export interface EC2CapacityReservationFleetProperties {
  /**
   ...
   * _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
   */
  TagSpecifications?: List<EC2CapacityReservationFleetTagSpecification>;
  /**
   ...
   * _Update requires_: [Replacement](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-update-behaviors.html#update-replacement)
   */
  InstanceTypeSpecifications?: List<EC2CapacityReservationFleetInstanceTypeSpecification>;
  /**
   * Property description not available.
   *
   * _Required_: No
 ...
 */
export interface EC2CapacityReservationFleetResource {
