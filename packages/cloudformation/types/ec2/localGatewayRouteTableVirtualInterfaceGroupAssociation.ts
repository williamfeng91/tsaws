...
export interface EC2LocalGatewayRouteTableVirtualInterfaceGroupAssociationProperties {
  /**
 ...
 */
export interface EC2LocalGatewayRouteTableVirtualInterfaceGroupAssociationResource {
